...
const WATER_MAT := preload('res://Environment/Ocean/assets/water/mat_water.tres')
const SPRAY_MAT := preload('res://Environment/Ocean/assets/water/mat_spray.tres')
const WATER_MESH_HIGH := preload('res://Environment/Ocean/assets/water/clipmap_high.obj')
const WATER_MESH_LOW := preload('res://Environment/Ocean/assets/water/clipmap_low.obj')
