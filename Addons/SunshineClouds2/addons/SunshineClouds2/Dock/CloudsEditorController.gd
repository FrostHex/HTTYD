...
var drawBrushToolMaterial : BaseMaterial3D = preload("res://Addons/SunshineClouds2/addons/SunshineClouds2/Dock/Materials/DrawBrushToolsMaterial.tres")
var drawBrushToolPrefab : PackedScene = preload("res://Addons/SunshineClouds2/addons/SunshineClouds2/Dock/CloudsDrawBrush.tscn")
...
func UpdateMaskSettings():
	...
	if (driver != null && driver.clouds_resource != null):
		...
		if (!UseMaskToggle.button_pressed):
			driver.clouds_resource.extra_large_noise_patterns = ResourceLoader.load("res://Addons/SunshineClouds2/addons/SunshineClouds2/NoiseTextures/ExtraLargeScaleNoise.tres")
...
func InitializeCompute():
	...
	if not compute_shader:
		compute_shader = ResourceLoader.load("res://Addons/SunshineClouds2/addons/SunshineClouds2/Dock/MaskDrawingCompute.glsl")
