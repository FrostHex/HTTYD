...
public partial class SunshineClouds : CompositorEffect
{
    ...
    public void InitializeCompute()
    {
        ...
        if (DitherNoise == null) {
            DitherNoise = ResourceLoader.Load("res://Addons/SunshineClouds2/addons/SunshineClouds2/NoiseTextures/bluenoise_Dither.png") as Texture3D;
        }
        if (HeightGradient == null){
            HeightGradient = ResourceLoader.Load("res://Addons/SunshineClouds2/addons/SunshineClouds2/NoiseTextures/HeightGradient.tres") as Texture2D;
        }
        if (ExtraLargeNoisePatterns == null){
            ExtraLargeNoisePatterns = ResourceLoader.Load("res://Addons/SunshineClouds2/addons/SunshineClouds2/NoiseTextures/ExtraLargeScaleNoise.tres") as Texture2D;
        }
        if (LargeScaleNoise == null){
            LargeScaleNoise = ResourceLoader.Load("res://Addons/SunshineClouds2/addons/SunshineClouds2/NoiseTextures/LargeScaleNoise.tres") as Texture3D;
        }
        if (MediumScaleNoise == null){
            MediumScaleNoise = ResourceLoader.Load("res://Addons/SunshineClouds2/addons/SunshineClouds2/NoiseTextures/MediumScaleNoise.tres") as Texture3D;
        }
        if (SmallScaleNoise == null){
            SmallScaleNoise = ResourceLoader.Load("res://Addons/SunshineClouds2/addons/SunshineClouds2/NoiseTextures/SmallScaleNoise.tres") as Texture3D;
        }
        if (CurlNoise == null){
            CurlNoise = ResourceLoader.Load("res://Addons/SunshineClouds2/addons/SunshineClouds2/NoiseTextures/curl_noise_varied.tga") as Texture3D;
        }


        if (ComputeShader == null)
        {
            ComputeShader = ResourceLoader.Load<RDShaderFile>("res://Addons/SunshineClouds2/addons/SunshineClouds2/SunshineCloudsCompute.glsl");
        }
        if (PrePassComputeShader == null)
        {
            PrePassComputeShader = ResourceLoader.Load<RDShaderFile>("res://Addons/SunshineClouds2/addons/SunshineClouds2/SunshineCloudsPreCompute.glsl");
        }

        if (PostPassComputeShader == null)
        {
            PostPassComputeShader = ResourceLoader.Load<RDShaderFile>("res://Addons/SunshineClouds2/addons/SunshineClouds2/SunshineCloudsPostCompute.glsl");
        }
