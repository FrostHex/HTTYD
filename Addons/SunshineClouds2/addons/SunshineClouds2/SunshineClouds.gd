...
@export var dither_noise : Texture
@export var height_gradient : Texture
@export var extra_large_noise_patterns : Texture
@export var large_scale_noise : Texture
@export var medium_scale_noise : Texture
@export var small_scale_noise : Texture
@export var curl_noise : Texture
...
func initialize_compute():
	...
	if not dither_noise:
		dither_noise = ResourceLoader.load("res://Addons/SunshineClouds2/addons/SunshineClouds2/NoiseTextures/bluenoise_Dither.png")
	if not height_gradient:
		height_gradient = ResourceLoader.load("res://Addons/SunshineClouds2/addons/SunshineClouds2/NoiseTextures/HeightGradient.tres")
	if not extra_large_noise_patterns:
		extra_large_noise_patterns = ResourceLoader.load("res://Addons/SunshineClouds2/addons/SunshineClouds2/NoiseTextures/ExtraLargeScaleNoise.tres")
	if not large_scale_noise:
		large_scale_noise = ResourceLoader.load("res://Addons/SunshineClouds2/addons/SunshineClouds2/NoiseTextures/LargeScaleNoise.tres")
	if not medium_scale_noise:
		medium_scale_noise = ResourceLoader.load("res://Addons/SunshineClouds2/addons/SunshineClouds2/NoiseTextures/MediumScaleNoise.tres")
	if not small_scale_noise:
		small_scale_noise = ResourceLoader.load("res://Addons/SunshineClouds2/addons/SunshineClouds2/NoiseTextures/SmallScaleNoise.tres")
	if not curl_noise:
		curl_noise = ResourceLoader.load("res://Addons/SunshineClouds2/addons/SunshineClouds2/NoiseTextures/curl_noise_varied.tga")
	
	if not compute_shader:
		compute_shader = ResourceLoader.load("res://Addons/SunshineClouds2/addons/SunshineClouds2/SunshineCloudsCompute.glsl")
	if not pre_pass_compute_shader:
		pre_pass_compute_shader = ResourceLoader.load("res://Addons/SunshineClouds2/addons/SunshineClouds2/SunshineCloudsPreCompute.glsl")
	if not post_pass_compute_shader:
		post_pass_compute_shader = ResourceLoader.load("res://Addons/SunshineClouds2/addons/SunshineClouds2/SunshineCloudsPostCompute.glsl")
